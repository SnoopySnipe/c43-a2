...
public class ListDriver extends RunnableDriver {
	...
	public void help() {
		...
		System.err.println("\ta -> Reported ranking list of players.");
	}
	...
	public void run(String... args) throws Exception {
		...
		String result = a2.listPlayerRanking().trim();
		appendFile(result, args[3]);
